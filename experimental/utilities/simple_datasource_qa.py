...
from experimental.utilities.vizql_data_service import list_fields, list_datasources
...
def augment_datasource_metadata(
    ...
    # MCP ONLY: fetch rich field metadata via MCP list-fields
    ...
    # MCP ONLY: basic datasource meta from MCP list-datasources
