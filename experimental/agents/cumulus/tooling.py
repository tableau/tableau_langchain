"""
Cumulus Agent Tooling - Filtered MCP Tools

This module loads MCP tools and filters datasource results to show ONLY financial/wealth-related datasources.
"""
...
# Filter keywords for Cumulus agent
CUMULUS_KEYWORDS = ['Cumulus', 'Wealth', 'Financial', 'Banking', 'Insurance', 'Lending', 'AUM']
...
for tool in all_tools:
    if 'list' in tool.name.lower() and 'datasource' in tool.name.lower():
        ...
        filtered_tool = create_filtered_list_datasources(tool, CUMULUS_KEYWORDS)
